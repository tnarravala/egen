...
def trigger_dag(data, context=None):
    ...
    client_id = '177116753074-c410ghbkrdcv5ckkni58v8k1jr1sqr8b.apps.googleusercontent.com'
    # This should be part of your webserver's URL:
    # {tenant-project-id}.appspot.com
    webserver_id = 'pa52081f3935b8b45p-tp'
    # The name of the DAG you wish to trigger
    dag_name = 'example_gcs_to_bigquery_operator'
    webserver_url = (
            'https://'
            + webserver_id
